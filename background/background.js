...
// Variable to store the demo prompt
const demoPrompt = "This is a demo prompt generated by background.js.";
...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
  if (message.action === "sendText") {
    ...
    // Send back the demo prompt
    sendResponse({ prompt: demoPrompt });
  }
});
